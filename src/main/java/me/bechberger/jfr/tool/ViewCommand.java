...
public final class ViewCommand implements Callable<Integer>, Footerable {
    ...
    @Option(names = "--verbose", description = "Displays the query that makes up the view")
    private boolean verbose = false;

    @Option(names = "--width", description = "The width of the view in characters. Default value depends on the view")
    private Integer width = null;

    @Option(names = "--truncate", description = "How to truncate content that exceeds space in a table cell. Mode can be 'beginning' or 'end'. Default is 'end'")
    private Truncate truncate = null;

    @Option(names = "--cell-height", description = "Maximum number of rows in a table cell. Default value depends on the view")
