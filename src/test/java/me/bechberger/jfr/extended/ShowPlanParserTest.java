 ...
 * @since 3.0
 */
public class ShowPlanParserTest {
    ...
    void testShowPlanNodeFormat() {
        ...
        assertTrue(formatted.contains("SHOW PLAN ASCII"), "Should contain SHOW PLAN ASCII, but got: " + formatted);
        assertTrue(formatted.contains("@SELECT *"), "Should contain @SELECT *, but got: " + formatted);
        assertTrue(formatted.contains("FROM Events"), "Should contain FROM Events, but got: " + formatted);
    }
    ...
    void testExplainNodeFormat() {
        ...
        assertTrue(formatted.contains("EXPLAIN"), "Should contain EXPLAIN, but got: " + formatted);
        assertTrue(formatted.contains("@SELECT name"), "Should contain @SELECT name, but got: " + formatted);
        assertTrue(formatted.contains("FROM Events"), "Should contain FROM Events, but got: " + formatted);
    }
